...
row.names(themes_data) <- 
        c("Modality: Offline", "Modality: Online grad school", "Modality: Social media",
          "Reasons: Lack of resources", "Reasons: School resources available", 
          "Reasons: Teacher capital", "Reasons: Change", 
          "Reasons: Two-worlds pitfall", "Reasons: Personal-professional boundaries", 
          "Reasons: Connecting", "Reasons: Planning", "Reasons: Enacting practice",
...
row.names(modalities_data) <- 
        c("Reasons: Lack of resources", "Reasons: School resources available", 
          "Reasons: Teacher capital", "Reasons: Change", 
          "Reasons: Two-worlds pitfall", "Reasons: Personal-professional boundaries", 
          "Reasons: Connecting", "Reasons: Planning", "Reasons: Enacting practice",
          "Supports: Assigned and appreciated", "Supports: Assigned but unhelpful",
